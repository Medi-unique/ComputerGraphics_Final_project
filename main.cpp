...
void drawStarSystem() {
    glPushMatrix();
    glRotated(starSystem.rotationAngle, 0.0, 0.5, 0.0); // Rotate the entire star system
...
int main(int argc, char** argv) {
    ...
    Planet mercury = {2.0, 0.0, 8.0, 0.1, {0.7f, 0.7f, 0.7f}};
    Planet venus = {4.0, PI / 4, 1.0, 0.15, {1.0f, 0.5f, 0.0f}};
    Planet earth = {6.0, PI / 2, 1, 0.2, {0.0f, 0.0f, 1.0f}};
